...
<!--导航栏-->
	...
	<?php if(is_array($sellertab)): $i = 0; $__LIST__ = array_slice($sellertab,0,3,true);if( count($__LIST__)==0 ) : echo "抱歉，暂时没有图书信息。" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="/broken/index.php/Home/Life/store/id/<?php echo ($v["sid"]); ?>" target="_blank">
	 	<li>
		  <div class="am-g">
		    ...
		    <div class="am-u-sm-8">
		    	<div class="am-g">
		    		<div class="am-u-sm-8" id="list2">
		    			<p id="list2_p1"><?php echo ($v["shopname"]); ?><small class="am-serif"><?php echo ($v["author"]); ?></small></p>
		    		...
		    		<div class="am-u-sm-4" id="list3">
		    			<a class="am-icon-pencil-square am-icon-lg" data-am-collapse="{parent: '#accordion', target: '#<?php echo ($v["sid"]); ?>'}"></a>
		    		</div>
		    	</div>
		    </div>
		</div> 

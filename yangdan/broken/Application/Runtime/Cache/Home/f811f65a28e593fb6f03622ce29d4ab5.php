...
<div class="am-g" id="g1" >
	...
	<ul class="am-list">
	<?php if(is_array($sellertab)): $i = 0; $__LIST__ = array_slice($sellertab,0,4,true);if( count($__LIST__)==0 ) : echo "抱歉，暂时没有店铺信息。" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/broken/index.php/Home/Amusement/yl_moviestore/id/<?php echo ($vo["sid"]); ?>" id="am-list-a" >
	  	<li>
		  <div class="am-g">
		  ...
		  <div id="<?php echo ($vo["sid"]); ?>" class="am-panel-collapse am-collapse">
			  <div class="am-panel-bd">
				  ...
				  <?php if(is_array($vo["chiptwo"])): $i = 0; $__LIST__ = array_slice($vo["chiptwo"],0,2,true);if( count($__LIST__)==0 ) : echo "抱歉，暂时没有可选标签。" ;else: foreach($__LIST__ as $key=>$k): $mod = ($i % 2 );++$i;?><div class="am-g" id="g4" >				    

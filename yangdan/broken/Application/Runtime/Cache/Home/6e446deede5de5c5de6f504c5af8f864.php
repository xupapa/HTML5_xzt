...
<div class="am-g" id="g1" >
	...
	<!-- 列表 -->
	<ul class="am-list">
	<?php if(is_array($sellertab)): $i = 0; $__LIST__ = array_slice($sellertab,0,null,true);if( count($__LIST__)==0 ) : echo "抱歉，暂时没有店铺信息。" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/broken/index.php/Home/Amusement/yl_sportsstore/id/<?php echo ($vo["sid"]); ?>" id="am-list-a" >
	  <li>
		  <div class="am-g">
		  ...
		  <div id="<?php echo ($vo["sid"]); ?>" class="am-panel-collapse am-collapse">
			  <div class="am-panel-bd">
				  <div class="am-g" id="g3">
					  <?php if(is_array($vo["chiptwo"])): $i = 0; $__LIST__ = $vo["chiptwo"];if( count($__LIST__)==0 ) : echo "抱歉，暂时没有标签信息。" ;else: foreach($__LIST__ as $key=>$k): $mod = ($i % 2 );++$i;?><a class="clickme" id="<?php echo ($k["id"]); ?>" href="javascript:void(0);"><div  class="am-badge am-round am-badge-secondary am-text-sm" id="badge1"><?php echo ($k["chipname"]); ?> <span><?php echo ($k["clickcount"]); ?></span></div></a><?php endforeach; endif; else: echo "抱歉，暂时没有店铺信息。" ;endif; ?>
				  </div>
       ...
       </a><?php endforeach; endif; else: echo "抱歉，暂时没有标签信息。" ;endif; ?>
